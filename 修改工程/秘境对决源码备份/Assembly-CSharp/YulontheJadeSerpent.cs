...
public class YulontheJadeSerpent : MinionCard
{
	...
	{
		if (this.Player.Hero.CurrentHealth <= this.Player.Enemy.Hero.CurrentHealth)
		{
			InterfaceManager.Instance.SpawnHealSplatOn(this.Player.Hero.Controller, this.Player.Enemy.Hero.CurrentHealth - this.Player.Hero.CurrentHealth);
		}
