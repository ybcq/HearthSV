...
public class Dominate : BaseHeroPower
{
	...
	{
		return target != null && target.IsFriendlyOf(this.Hero.Player.Enemy.Hero) && !target.HasSpellshield && target.IsMinion() && target.As<Minion>().Card.MinionType != MinionType.Totem;
	}
}
