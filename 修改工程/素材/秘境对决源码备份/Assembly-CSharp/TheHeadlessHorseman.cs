...
public class TheHeadlessHorseman : MinionCard
{
	...
	{
		this.Name = "终极图腾Lv9";
		this.Description = "Battlecry: Change Difficulty of this Game to Level 9.";
	...
	{
		baseCard.As<Minion>().HasCharge = true;
	}

	public void RemoveMinionAura(Minion baseCard)
	{
		baseCard.As<Minion>().HasCharge = false;
	}
	...
	{
		yield return self.Player.SummonMinion(new TheHeadlessHorseman());
		yield break;
	}
