...
public class AllWillServe : SpellCard
{
	...
	public override IEnumerator Cast(Character target)
	{
		...
		ChargeTurnGhoul AllWillServeCard = new ChargeTurnGhoul();
		yield return this.Player.SummonMinion(AllWillServeCard);
		if (AllWillServeCard.Minion != null)
		{
			AllWillServeCard.Minion.Mechanics.RemoveAll();
		}
		yield break;
	}
}
