...
public class MoamtheDestroyer : MinionCard
{
	...
	{
		this.Name = "溅射图腾Lv8";
		this.Description = "Battlecry: Change Difficulty of this Game to Level 8.";
	...
	public void ApplyMinionAura(Minion baseCard)
	{
		...
		baseCard.As<Minion>().HasCleave = true;
	}
	...
	public void RemoveMinionAura(Minion baseCard)
	{
		...
		baseCard.As<Minion>().HasCleave = false;
	}
	...
	{
		yield return self.Player.SummonMinion(new MoamtheDestroyer());
		yield break;
	}
