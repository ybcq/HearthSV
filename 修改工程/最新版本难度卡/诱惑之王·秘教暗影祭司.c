...
public class ScaleswornSkyrazor : SpellCard
{
	public ScaleswornSkyrazor()
	{
		this.Name = "挑战诱惑之王·秘教暗影祭司";
		this.Description = "Your opponent gains dominance skills.";
	...
	public IEnumerator OnGameStart()
	{
		...
		yield return this.Player.Enemy.ReplaceHeroPower(new Dominate(this.Player.Enemy.Hero));
