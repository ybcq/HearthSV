...
public class TeronGorefiend : MinionCard
{
	...
	{
		this.Name = "Teron Gorefiend";
		this.Description = "Battlecry and Deathrattle: Summon two 1/1 Ghostriders of Karabor with Charge.";
	...
	public IEnumerator Battlecry(Character character)
	{
		...
		yield return this.Player.SummonMinion(new GhostriderofKarabor(), teronPosition + 1);
		yield return this.Player.SummonMinion(new GhostriderofKarabor(), teronPosition);
